...
opcode_entry opcode_table [512] = {
  /* 0x00 */	IDEXW(G2E,add,1), IDEXW(G2E,add,4), IDEXW(E2G,add,1), IDEX(E2G,add),
  ...
  /* 0x68 */	IDEX(I,push), IDEX(I_E2G,imul3), IDEXW(I,pushl,1), EMPTY,
  ...
  /* 0xcc */	EMPTY, IDEXW(I,int,8), EMPTY, EMPTY,
