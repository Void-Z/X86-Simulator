...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    EX(inc), EMPTY, EX(call), EX(call_rm),
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(I,push), EMPTY, IDEXW(I,pushl,1), EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(movx_E2G,movzx), IDEX(movx_E2G,movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, EMPTY, IDEX(movx_E2G,movsx),
