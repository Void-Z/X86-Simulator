...
opcode_entry opcode_table [512] = {
  /* 0x00 */	EMPTY, IDEXW(G2E,add,4), EMPTY, IDEX(E2G,add),
  ...
  /* 0x20 */	EMPTY, EMPTY, IDEXW(E2G,and,1), IDEX(E2G,and),
  /* 0x24 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x28 */	EMPTY, IDEX(G2E,sub), EMPTY, IDEX(E2G,sub),
  /* 0x2c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x30 */	EMPTY, IDEXW(E2G, xor, 0), EMPTY, IDEX(E2G,xor),
  ...
  /* 0x68 */	EMPTY, EMPTY, IDEXW(I,pushl,1), EMPTY,
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x70 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x74 */	IDEXW(I,je,1), IDEXW(I,jne,1), EMPTY, EMPTY,
  /* 0x78 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x7c */	EMPTY, IDEXW(I,jge,1), IDEXW(I,jle,1), EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, EXW(ret,0),
  ...
  /* 0xe8 */	IDEXW(J, call, 4), EMPTY, EMPTY, IDEXW(I,jmp,1),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(movzx_E2G,movzx), EMPTY,
...
void exec_wrapper(bool print_flag) {
  ...
  printflog("stack : 0x%08x\n",*(uint32_t *)guest_to_host(cpu.esp % PMEM_SIZE + 12));
  printflog("stack : 0x%08x\n",*(uint32_t *)guest_to_host(cpu.esp % PMEM_SIZE + 16));
  printflog("stack : 0x%08x\n",*(uint32_t *)guest_to_host(cpu.esp % PMEM_SIZE + 20));
  printflog("stack : 0x%08x\n",*(uint32_t *)guest_to_host(cpu.esp % PMEM_SIZE + 24));
  printflog("stack : 0x%08x\n",*(uint32_t *)guest_to_host(cpu.esp % PMEM_SIZE + 28));
}
